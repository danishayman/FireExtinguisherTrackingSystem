                                    ...
                                    <div class="view-section">
                                        ...
                                        <div class="filter-section">
                                            ...
                                            <div class="expiry-filters">
                                                <div class="button-group">
                                                    <asp:Label ID="lblExpiryStats" runat="server"
                                                        CssClass="expiry-stats"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                ...
                <asp:Panel ID="pnlServiceSelection" runat="server" Width="100%" CssClass="modal-panel" Visible="false">
                    <div class="modal-content service-selection-modal">
                        ...
                        <div class="modal-body">
                            <p class="selection-instruction">Select the fire extinguishers you want to send for service
                                from the list below:</p>
                            <div class="grid-container">
                                <asp:GridView ID="gvServiceSelection" runat="server" Width="100%"
                                    AutoGenerateColumns="false" DataKeyNames="FEID" CssClass="grid-view selection-grid"
                                        ...
                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <HeaderTemplate>
                                                <input type="checkbox" onclick="toggleAllCheckboxes(this)"
                                                    id="chkSelectAll" class="selection-checkbox" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkSelect" runat="server"
                                                    CssClass="selection-checkbox" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <EmptyDataTemplate>
                                        <div class="empty-data-message">No fire extinguishers available to send for
                                            service.</div>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </div>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnConfirmSelection" runat="server" Text="Confirm Selection"
                                CssClass="btn btn-primary btn-lg" OnClick="btnConfirmSelection_Click" />
                            <asp:Button ID="btnCancelSelection" runat="server" Text="Cancel"
                                CssClass="btn btn-secondary btn-lg" OnClick="btnCancelSelection_Click"
                                OnClientClick="hideServiceSelectionPanel(); return true;" />
                        </div>
                    </div>
                </asp:Panel>
            </ContentTemplate>
