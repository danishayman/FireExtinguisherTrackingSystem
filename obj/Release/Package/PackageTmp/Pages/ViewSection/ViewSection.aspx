<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSection.aspx.cs" Inherits="FETS.Pages.ViewSection.ViewSection" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FETS - View Section</title>
...
<body>
    <form id="form1" runat="server">
                                                            ...
                                                            <div class="tab-container">
                                                                <div class="panel-header">
                                                                    <div class="tab-buttons">
                                                                        <asp:LinkButton ID="btnExpiredTab" runat="server" OnClick="btnExpiredTab_Click" CssClass='<%# GetTabButtonClass("expired") %>'>
                                                                            Expired (<%= ExpiredCount %>)
                                                                        </asp:LinkButton>
                                                                        <asp:LinkButton ID="btnExpiringSoonTab" runat="server" OnClick="btnExpiringSoonTab_Click" CssClass='<%# GetTabButtonClass("expiringSoon") %>'>
                                                                            Expiring Soon (<%= ExpiringSoonCount %>)
                                                                        </asp:LinkButton>
                                                                        <asp:LinkButton ID="btnUnderServiceTab" runat="server" OnClick="btnUnderServiceTab_Click" CssClass='<%# GetTabButtonClass("underService") %>'>
                                                                    ...
                                                                    <asp:View ID="vwExpired" runat="server">
                                                                        <asp:GridView ID="gvExpired" runat="server" 
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="DateExpired" HeaderText="Expiry Date" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                                                                <asp:TemplateField HeaderText="Actions" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:LinkButton ID="btnSendToService" runat="server" 
                                                                                            ...
                                                                                            <i class="fas fa-tools"></i> Send to Service
                                                                                        </asp:LinkButton>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                    ...
                                                                    <asp:View ID="vwUnderService" runat="server">
                                                                        <asp:GridView ID="gvUnderService" runat="server" 
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="DateExpired" HeaderText="Previous Expiry Date" DataFormatString="{0:d}" />
                                                                ...
                                                                <div class="action-buttons">
                                                                    ...
                                                                    <asp:Button ID="btnSendForService" runat="server" 
                                                                        ...
                                                                        Enabled='<%# (DateTime.Parse(Eval("DateExpired").ToString()) <= DateTime.Now || 
                                                                                  (DateTime.Parse(Eval("DateExpired").ToString()) - DateTime.Now).TotalDays <= 60) &&
                                                                                  Eval("StatusName").ToString() != "Under Service" %>'
                                                                        OnClientClick="return showSendToServiceConfirmation(this);" />
        ...
        <script type="text/javascript">
            ...
            function showSendToServiceConfirmation(button) {
                var feId;
                if (typeof button === 'string') {
                    // Called from "Send All" button
                    feId = button;
                } else {
                    // Called from individual button
                    feId = button.value;
                }
